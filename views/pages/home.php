...
?>
    <div class="row">
        <div class="yd dy0" style="width: 140px; border-radius: 20px;">
            <div class="dm1 d3m m3d d0y" style="color: rgb(255, 255, 255); background-color: rgb(248, 17, 85);">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style="color: rgb(255, 255, 255);">
                ...
                <span>Home</span></div>
            <span><a href="/movies">Movie Page</a></span>
        </div>
    </div>
